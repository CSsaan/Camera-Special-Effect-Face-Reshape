...
#ifndef CAMERASPECIALEFFECT_TOOTHWHITEN_H
#define CAMERASPECIALEFFECT_TOOTHWHITEN_H
...
class ToothWhiten:public BaseVideoRender
{
public:
    ToothWhiten();
    ~ToothWhiten();
...
private:
    void render();
    float mask_Coords[4*POINTS_NUM]{}; //4*使用关键点数
    //float points[3*2];
    void init_ToothWhiten_data();
    void render_ToothWhiten();
...
//    GLint x2y2_loc{};
    ...
    unsigned char *MASK_png_data2{}; // LUT
...
#endif //CAMERASPECIALEFFECT_TOOTHWHITEN_H
