...
#ifndef CAMERASPECIALEFFECT_FACERESHAPE_H
#define CAMERASPECIALEFFECT_FACERESHAPE_H
...
class FaceReshape:public BaseVideoRender
{
public:
    FaceReshape();
    ~FaceReshape();
...
private:
    ...
    float points[16];
    void init_FaceReshape_data();
    void render_FaceReshape();
...
#endif //CAMERASPECIALEFFECT_FACERESHAPE_H
